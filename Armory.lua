...
function Armory.GetStatisticData()
	...
	for _, Achievement in ipairs(AchievementList) do 
		...
		Statistics[Achievement].IDNumber = IDNumber
		Statistics[Achievement].Value = GetStatistic(Achievement)
		Statistics[Achievement].Name = Name
		Statistics[Achievement].Description = Description
		Statistics[Achievement].Points = Points
		Statistics[Achievement].Completed = Completed
		Statistics[Achievement].Month = Month
		Statistics[Achievement].Day = Day
		Statistics[Achievement].Year = Year
		Statistics[Achievement].Flags = Flags
		Statistics[Achievement].RewardText = RewardText
	end
	return Statistics
end
